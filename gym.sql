...
CREATE TABLE `gym_admin`  (
  ...
  `update_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '更新时间',
...
CREATE TABLE `gym_clock_count`  (
  ...
  `non_stop_count` int(11) NOT NULL DEFAULT 0 COMMENT '累计打卡次数',
...
CREATE TABLE `gym_coach`  (
  ...
  `created_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '创建时间',
  `update_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '更新时间',
  `update_by` char(11) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '更新信息的管理员账号',
...
CREATE TABLE `gym_menu`  (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '选项名称',
  `is_admin` int(2) NOT NULL DEFAULT 0 COMMENT '是否超级管理员0否 1是',
  PRIMARY KEY (`menu_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `gym_msg`  (
  ...
  `msg_content` varchar(140) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '消息内容',
  ...
  `send_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '发送时间',
...
CREATE TABLE `gym_power`  (
  `power_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `admin_id` int(4) NOT NULL COMMENT '管理员id',
  `menu_ids` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL COMMENT '菜单id',
...
CREATE TABLE `gym_project`  (
  ...
  `sort` tinyint(4) NOT NULL DEFAULT 0 COMMENT '项目排序0-100 大着优先',
